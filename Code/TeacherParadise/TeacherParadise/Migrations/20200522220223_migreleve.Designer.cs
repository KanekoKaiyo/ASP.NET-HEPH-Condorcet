...
namespace TeacherParadise.Migrations
{
    ...
    [Migration("20200522220223_migreleve")]
    partial class migreleve
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeacherParadise.Models.POCO.CEleve", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TeacherParadise.Models.POCO.CReservationCoursCollectif", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CReservationCoursCollectifs");
                });
            ...
            modelBuilder.Entity("TeacherParadise.Models.POCO.CReservationCoursCollectif", b =>
                {
                    b.HasOne("TeacherParadise.Models.POCO.CEleve", null)
                        .WithMany("ReservationCoursCollectifs")
                        .HasForeignKey("CEleveID");
                });
